...
set MALLET_CLASSPATH=C:\Users\micha\OneDrive\Desktop\mallet-2.0.8\class;C:\Users\micha\OneDrive\Desktop\mallet-2.0.8\lib\mallet-deps.jar
...
"C:\Program Files\Java\jdk1.8.0_241\bin\java" -ea -Dfile.encoding=%MALLET_ENCODING% -classpath %MALLET_CLASSPATH% %CLASS% %MALLET_ARGS%
